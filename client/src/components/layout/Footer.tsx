...
const Footer = () => {
  return (
    <footer className="bg-[#343A40] text-white py-8 sm:py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="text-center sm:text-left">
            <div className="flex items-center justify-center sm:justify-start mb-4">
              <Torus className="text-primary h-7 w-7 sm:h-8 sm:w-8 mr-2" />
              <h3 className="text-xl sm:text-2xl font-bold">Bright Smile Dental</h3>
            </div>
          ...
          <div className="text-center sm:text-left">
            <h4 className="text-lg font-bold mb-3 sm:mb-4">Quick Links</h4>
          ...
          <div className="text-center sm:text-left">
            <h4 className="text-lg font-bold mb-3 sm:mb-4">Services</h4>
            <ul className="space-y-1 sm:space-y-2">
          ...
          <div className="text-center sm:text-left">
            <h4 className="text-lg font-bold mb-3 sm:mb-4">Contact Us</h4>
            <ul className="space-y-2">
              <li className="flex items-start justify-center sm:justify-start">
                ...
                <span className="text-gray-400 text-sm sm:text-base">123 Dental Avenue, Suite 101<br/>Healthville, CA 90210</span>
              </li>
              <li className="flex items-center justify-center sm:justify-start">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-primary mr-3 flex-shrink-0">
              ...
              <li className="flex items-center justify-center sm:justify-start">
                ...
                <span className="text-gray-400 text-sm sm:text-base">info@brightsmile.com</span>
              </li>
              <li className="flex items-center justify-center sm:justify-start">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-primary mr-3 flex-shrink-0">
                ...
                <span className="text-gray-400 text-sm sm:text-base">Mon-Fri: 8AM-6PM, Sat: 9AM-2PM</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center">
          <p className="text-gray-400 text-xs sm:text-sm mb-4 sm:mb-0 text-center sm:text-left">&copy; {new Date().getFullYear()} Bright Smile Dental. All rights reserved.</p>
          <div className="flex flex-wrap justify-center sm:justify-start space-x-4 sm:space-x-6">
            <a href="#" className="text-gray-400 hover:text-primary text-xs sm:text-sm transition-colors">Privacy Policy</a>
            <a href="#" className="text-gray-400 hover:text-primary text-xs sm:text-sm transition-colors">Terms of Service</a>
            <a href="#" className="text-gray-400 hover:text-primary text-xs sm:text-sm transition-colors">Sitemap</a>
          </div>
        </div>
      </div>
    </footer>
