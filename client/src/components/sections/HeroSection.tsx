    ...
    <section id="home" className="pt-24 pb-16 md:pt-32 md:pb-24">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center">
          ...
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 text-center md:text-left">
              Your Perfect Smile <span className="text-primary">Begins Here</span>
            </h2>
            <p className="text-base sm:text-lg text-gray-600 mb-6 text-center md:text-left">
          ...
          >
            <img 
              ...
              className="rounded-lg shadow-lg w-full h-auto max-w-md mx-auto md:max-w-none"
            />
          </motion.div>
        </div>
